...
var map = {
	"./accordion_controller.js": "./src/js/controllers/accordion_controller.js",
	...
	"./search_controller.js": "./src/js/controllers/search_controller.js",
	"./slider-center_controller.js": "./src/js/controllers/slider-center_controller.js",
	"./slider-five_controller.js": "./src/js/controllers/slider-five_controller.js",
	"./slider-four_controller.js": "./src/js/controllers/slider-four_controller.js",
	"./slider-three_controller.js": "./src/js/controllers/slider-three_controller.js",
...
/***/ "./src/js/controllers/accordion_controller.js":
/*!****************************************************!*\
  !*** ./src/js/controllers/accordion_controller.js ***!
  \****************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function toggle() {
      this.targetTargets.map(function (item) {
    ...
    value: function mobile() {
      ...
      this.allTarget.addEventListener("click", function (evt) {
        evt.preventDefault();

        _this.allTarget.parentElement.classList.toggle("sidebar__item--active");

        _this.element.classList.toggle("sidebar--mobile");
      });
    }
  }]);
...
_defineProperty(_default, "targets", ["target", "list", "all"]);
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "init",
    value: function init() {
      this.targetTargets.forEach(function (item) {
        item.addEventListener("click", function (evt) {
          evt.preventDefault();
...
_defineProperty(_default, "targets", ["target", "list"]);
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function init() {
      ...
      this.targetTarget.addEventListener("click", function (evt) {
        evt.preventDefault();

        _this.element.classList.toggle("language--active");
      });
    }
  }]);
  ...
  _createClass(_default, [{
    ...
    value: function hideOnHover() {
      ...
      this.listTarget.addEventListener("mouseout", function () {
        var active = _this.listTarget.querySelector(".mega-menu__item");
...
_defineProperty(_default, "targets", ["item", "trigger", "list"]);
...
_defineProperty(_default, "targets", ["overlay", "close"]);
...
/***/ "./src/js/controllers/slider-five_controller.js":
/*!******************************************************!*\
  !*** ./src/js/controllers/slider-five_controller.js ***!
  \******************************************************/
/*! exports provided: default */
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "init",
    value: function init() {
      var sliderFive = Object(tiny_slider_src_tiny_slider__WEBPACK_IMPORTED_MODULE_1__["tns"])({
        container: this.listTarget,
        items: 1,
        controls: true,
        nav: false,
...
/***/ "./src/js/controllers/slider-four_controller.js":
/*!******************************************************!*\
  !*** ./src/js/controllers/slider-four_controller.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./src/js/controllers/slider-three_controller.js":
/*!*******************************************************!*\
  !*** ./src/js/controllers/slider-three_controller.js ***!
  \*******************************************************/
/*! exports provided: default */
...
Array.prototype.forEach.call(inputs, function (input) {
  ...
  input.addEventListener('change', function (e) {
    ...
    if (countFiles) label.querySelector('.file__text').innerText = 'Выбрано файлов: ' + countFiles;else label.querySelector('.file__text').innerText = labelVal;
  });
});
